...
class KamarController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'foto' => 'required|image|mimes:png,jpg,jpeg|dimensions:min_width=100,min_height=500|between:50,1000',
            'jumlah' => 'required',
            'harga' => 'required',
    ...
    public function update(Request $request, Kamar $kamar)
    {
        $request->validate([
            'nama_kamar' => 'required|min:3',
            'foto' => 'nullable|image|mimes:png,jpg,jpeg|dimensions:min_width=100,min_height=500|between:50,1000',
            'jumlah' => 'required',
            'harga' => 'required',
            'deskripsi' => 'required|min:10'
        ]);
